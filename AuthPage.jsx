        ...
        try {
            if (isLogin) {
                ...
                await setDoc(doc(db, 'users', userCredential.user.uid), {
                    userId: userCredential.user.uid, email, fullName, username,
    ...
    return (
        <div className="min-h-screen bg-gray-900 flex flex-col justify-center items-center py-12 px-4">
            <div className="w-full max-w-md">
                <h2 className="text-center text-3xl font-extrabold text-white">{isLogin ? 'Connectez-vous' : 'Créez un compte'}</h2>
            </div>
